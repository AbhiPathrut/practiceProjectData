...
public class HomePage extends TestBase {
	...
	@FindBy(xpath = "//div[contains(@data-name,'Subtotals')] //span[contains(@class,'sc-price')]")
	WebElement subTotalAmt;

	@FindBy(xpath = "//div[contains(@class,'list-item')] //span[contains(@class,'sc-product-price')]")
